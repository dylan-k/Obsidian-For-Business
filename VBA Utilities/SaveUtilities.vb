...
Public Sub ReplaceCharsForFileName(temporarySubjectLineString As String, sChr As String)
  ' Creates a filename, using email subject stripped of invalid characters and spaces
  ' The `sChr` string is undefined here, to replace characters with nothing
  ' Possibly more efficient/reusable method: https://superuser.com/a/901461/236141
  temporarySubjectLineString = Replace(temporarySubjectLineString, "/", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, "\", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, ":", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, "?", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, Chr(34), sChr) 'remove quote
  temporarySubjectLineString = Replace(temporarySubjectLineString, "<", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, ">", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, "|", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, "[", sChr)
  ...
  temporarySubjectLineString = Replace(temporarySubjectLineString, "*", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, ".", sChr)
  temporarySubjectLineString = Replace(temporarySubjectLineString, " ", "-")
  temporarySubjectLineString = LCase(temporarySubjectLineString)
End Sub
'======================================================================================='
